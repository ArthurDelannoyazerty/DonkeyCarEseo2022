# donkeycar: a python self driving library - Fast&Curious Edition - v4.2
![donkeycar](./donkeycar/parts/web_controller/templates/static/fclogo.png)

Check **[Fast & Curious CHANGELOG](./docs/fastandcurious/CHANGELOG.md)** !
