...
parser.add_argument('--input', help='Path to input image.', default='867_cam_image_array_.jpg')
args = parser.parse_args()
"""

##load imagesv
origin = cv.imread(cv.samples.findFile("867_cam_image_array_.jpg"))
if origin is None:
...
_,thresholdImage = cv.threshold(gray, 180, 255, type=cv.THRESH_TOZERO)
