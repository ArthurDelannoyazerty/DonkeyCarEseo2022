...
class LocalWebController(tornado.web.Application):
    ...
    def run_threaded(self, img_arr=None, num_records=0):
        ...
        if not (self.fcsetting == ":" or self.fcsetting == "undefined:undefined"):
            if not (self.fcsetting == self.fcsettinglast):
                print("F&C : New setting received : " + str(self.fcsetting))
                self.fcsettinglast = self.fcsetting

        return self.angle, self.throttle, self.mode, self.recording, self.fcsetting
...
class DriveAPI(RequestHandler):
    ...
    def post(self):
        ...
        self.application.fcsetting = data['fcsetting']
